...
using AccessEvent = Foobiq.AccessControl.Events.AccessEvent;
...
namespace Foobiq.AccessPoint.Services
{
    public sealed class AccessPointService : IAccessPointService
    {
        ...
        private readonly Foobiq.AccessControl.AppService.Contracts.IAuthorizationClient _authorizationClient;
        ...
        public AccessPointService(
            ...
            Foobiq.AccessControl.AppService.Contracts.IAuthorizationClient authorizationClient)
        {
            this.logger = logger;
